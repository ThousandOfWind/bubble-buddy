...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "status.local_preview": {"zh": "录音中 · 本地草稿（会随后续语境修订）", "en": "Recording · Local draft (may revise with more context)"},
    "status.local_preview_failed": {"zh": "本地预览暂停，录音继续；停止后仍会完整转写：{error}", "en": "Local preview unavailable; still recording for final transcription: {error}"},
    ...
    "settings.field.local_preview": {"zh": "按停顿预览（草稿可修订，仅最终粘贴）", "en": "Pause-adaptive preview (revisable draft, final-only paste)"},
